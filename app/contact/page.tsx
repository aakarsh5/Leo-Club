...
export const metadata = {
  ...
  description:
    "Get in touch with Leo Club of Biratnagar Central Megha. Send us a message, visit our office, or connect with us on social media.",
}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      info@leoclubbiratnagar.org
                      <br />
                      president@leoclubbiratnagar.org
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="text-sm">11:00 AM - 3:00 PM</p>
                </div>
                <div className="flex justify-between">
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  Note: Hours may vary during events and holidays. Please call ahead to confirm.
                </p>
              </CardContent>
            </Card>
            <Card>
